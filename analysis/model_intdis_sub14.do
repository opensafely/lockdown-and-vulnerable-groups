...
*summary stats
tabstat consultations_sub14 population_sub14 if _z==0, statistics(sum) by(period)
tabstat consultations_sub14 population_sub14 if _z==1, statistics(sum) by(period)
