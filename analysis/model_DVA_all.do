...
*Get data
use "$dir/output/dva_all.dta", clear
...
save "$dir/output/dva_all2.dta", replace
...
graph export "$dir/output/dva_ratioLoess1.svg", replace
...
use "$dir/output/dva_all2.dta", clear
...
graph export "$dir/output/dva_ratioLoess2.svg", replace
...
save "$dir/output/dva_all2_ld2.dta", replace
