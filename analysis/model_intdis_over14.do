...
*summary stats
tabstat consultations_over14 population_over14 if _z==0, statistics(sum) by(period)
tabstat consultations_over14 population_over14 if _z==1, statistics(sum) by(period)
