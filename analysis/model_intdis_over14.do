...
*summary stats
tabstat consultations_over14 population_over14 if _z==0, statistics(mean) by(period) format(%20.2f)
tabstat consultations_over14 population_over14 if _z==1, statistics(mean) by(period) format(%20.2f)
