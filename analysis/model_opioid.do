...
/* Data used:		output/measure_opioid_rate.csv				*/
...
/*					Covid lockdowns for people with opioid	 	*/
/*					dependence									*/
/****************************************************************/
...
save "$dir/output/opioid.dta", replace
...
graph export "$dir/output/opioid_ratioLoess1.svg", replace
...
putexcel set "$dir/output/CITS_opioid.xlsx", sheet("Opioid1") replace
...
predict res, pearson
predict error, stdp
generate ll=opioid_pred_rate - invnormal(0.975)*error
generate ul=opioid_pred_rate + invnormal(0.975)*error
...
use "$dir/output/opioid.dta", clear
...
graph export "$dir/output/opioid_ratioLoess2.svg", replace
...
*export model outputs
putexcel set "$dir/output/CITS_opioid.xlsx", sheet("Opioid2") modify
putexcel A1=matrix(r(table)), names 
...
predict error2, stdp
generate ll2=opioid_pred_rate2 - invnormal(0.975)*error2
generate ul2=opioid_pred_rate2 + invnormal(0.975)*error2
...
graph export "$dir/output/opioid_plot2.svg", replace
